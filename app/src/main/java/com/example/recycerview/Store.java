...
public class Store {
    ...
    public static List<Store> getMock()
    {
        return new ArrayList<>(Arrays.asList(
                new Store(R.drawable.bep_ba_muoi,21600000,79200000,"Bếp bà muối - Ăn vặt Online","49 Khải hoàn ,Phường phú nhuận",new ArrayList<>(Arrays.asList(ServiceType.SHOP_ONLINE,ServiceType.BIRDTH_DAY)),"",0),
